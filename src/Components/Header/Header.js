...
export default class Header extends Component {
  ...
  login() {
    ...
    axios.post('/auth/login', { username: username, password: password, isAdmin: isAdmin }).then(response => {
  ...
  register() {
    let { username, password, isAdmin } = this.state
    axios.post('/auth/register', { username: username, password: password, isAdmin: isAdmin }).then((response) => {
      this.setState({ username: '', password: '' })
      this.props.updateUser(response.data)
    }).catch(err => {
      this.setState({ username: '', password: '' })
